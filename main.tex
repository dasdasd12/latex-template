...
\begin{gather}
  PSR_{LDO} = \frac{PSR_1}{\beta \cdot A_{v1a} \cdot A_{v1b}} 
    + \frac{PSR_2}{\beta \cdot A_{v1a} \cdot A_{v1b} \cdot A_{v2}} 
    + \frac{PSR_{POW}}{\beta \cdot A_{v1a} \cdot A_{v1b} \cdot A_{v2} \cdot A_{v,POW}}
\end{gather}

其中$\beta = R_{F2} / (R_{F1} + R_{F2})$为反馈网络分压系数，$PSR_1$、$PSR_2$、$PSR_{POW}$分别为第一级（折叠轨到轨）、第二级（共源级）、功率级单独的电源噪声抑制特性，$A_{v1a}$、$A_{v1b}$、$A_{v2}$、$A_{v,POW}$分别为各级的电压增益。
